...
/**
 * Keybind registration and handling for aircraft controls.
 *
 * Keybinds:
 * - Numpad +/-: Thrust increase/decrease (slowly like MSFS)
 * - W: Pitch down (nose down via rear flaps)
 * - S: Pitch up (nose up via rear flaps)
 ...
 *
 * Note: When sitting in control chair, mouse is free for GUI (flaps control)
 */
